...
## Usage
Please see [godoc.org](http://godoc.org/github.com/ebostijancic/gatt) for documentation.
...
Please check [#32](https://github.com/ebostijancic/gatt/issues/32) for the status of this issue.
